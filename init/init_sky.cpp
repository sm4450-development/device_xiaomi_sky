...
void vendor_load_properties() {
	...
	set_device_props(
	    "POCO/sky_p_in/sky:12/SKQ1.230118.001/V816.0.5.0.UMWCNXM:user/release-keys",
            "sky-user-12-SKQ1.230118.001-V816.0.5.0.UMWCNXM:user-release-keys", "POCO", "sky",
            "23076PC4BI", "sky_p_in", "POCO M6 Pro 5G");
    } else {
        set_device_props(
            "Redmi/sky_in/sky:12/SKQ1.230118.001/V816.0.5.0.UMWCNXM:user/release-keys",
            "sky-user-12-SKQ1.230118.001-V816.0.5.0.UMWCNXM:user-release-keys", "Redmi", "sky",
